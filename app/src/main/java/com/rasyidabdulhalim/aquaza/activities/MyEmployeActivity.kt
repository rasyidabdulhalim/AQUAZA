...
class MyEmployeActivity : BaseActivity(), TabLayout.OnTabSelectedListener {
    ...
    companion object {
        private const val EMPLOYES = "Employe"
        private const val BOARD = "Board Employee"
    }
    ...
    private fun initViews() {
        ...
        supportActionBar?.title = "My Employee"
    ...
    private fun setupViewPager() {
        ...
        val cars = MyEmployeeFragment()
        val parts = MyEmployeeBoardFragment()
